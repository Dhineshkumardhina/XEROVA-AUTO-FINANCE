...
import { 
  ...
  ShieldAlert, Bot, LogOut, Clock, UserCheck, RefreshCw, AlertCircle, 
  Send, X, FileCheck, CheckCircle, Fingerprint, Users, Bell,
  ChevronDown, ChevronRight, PiggyBank, Scale, Coins, Printer,
  Briefcase, ListFilter, AlertTriangle, FileSpreadsheet
} from "lucide-react";
...
// Extended Views for XEROVA AUTO FINANCE
...
export default function App() {
  ...
  // Floating AI Underwriting Copilot Chat State
  const [aiChatOpen, setAiChatOpen] = useState(false);
  const [chatMessage, setChatMessage] = useState("");
  const [chatHistory, setChatHistory] = useState<any[]>([
    { role: "assistant", text: "Hello! I am Ask Me, your intelligent XEROVA Auto Finance assistant. I have full real-time access to all loans, customer records, GPS locator telemetry, receipts, and ledger analytics. How can I help you today?" }
  ]);
  ...
  const handleSendAiMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setChatHistory((prev) => [...prev, { role: "assistant", text: "I ran into a server error processing your request. Please check GEMINI_API_KEY." }]);
      }
    } catch (err) {
      setChatHistory((prev) => [...prev, { role: "assistant", text: "Network error connecting to Ask Me engine." }]);
    } finally {
      setAiLoading(false);
    }
  };
  ...
  // Intercept and load Customer Portal standalone view directly if Role is Customer
  if (userProfile?.role === "Customer Portal") {
    return (
      <CustomerPortalView userPhone={userProfile.phone} onLogout={handleLogout} />
    );
  }
    ...
    switch (action) {
      case "PRELOAN_SUBMITTED":
        return {
          ...
          image: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=100&auto=format&fit=crop&q=60",
          icon: FileText
        };
      case "PRELOAN_STATUS_UPDATE":
        ...
        return {
          ...
          color: isApproved ? "bg-green-500" : isRejected ? "bg-rose-500" : "bg-amber-500",
          textColor: isApproved ? "text-green-600" : isRejected ? "text-rose-600" : "text-amber-600",
          bgColor: isApproved ? "bg-green-50 border-green-200" : isRejected ? "bg-rose-50 border-rose-200" : "bg-amber-50 border-amber-200",
          image: isApproved 
            ? "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=100&auto=format&fit=crop&q=60" 
            : "https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=100&auto=format&fit=crop&q=60",
      ...
      case "CREATE_HP_LEDGER":
        return {
          ...
          image: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=100&auto=format&fit=crop&q=60",
          icon: FileCheck
        };
      case "VEHICLE_SEIZED":
        return {
          ...
          image: "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=100&auto=format&fit=crop&q=60",
          icon: ShieldAlert
        };
      case "COLLECTION_RECEIPT_POSTED":
        return {
          ...
          image: "https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=100&auto=format&fit=crop&q=60",
          icon: Wallet
        };
      default:
        return {
          ...
          image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=100&auto=format&fit=crop&q=60",
          icon: RefreshCw
        };
    }
  };
